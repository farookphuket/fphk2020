...
<div class="input-group mb-3">
  ...
  <input type="text" name="meta_url" class="form-control meta_url" id="meta_url" name="meta_url"  aria-describedby="meta_key1" disabled>
...
<div class="col-lg-12">
  <textarea class="form-control tour_summary" id="tour_summary" name="tour_summary" aria-label="tour_summary" rows="8"></textarea>
</div>


<label for="tour_detail">Tour detail</label>
<div class="col-lg-12">
  <textarea class="form-control  tour_detail" id="tour_detail" aria-label="tour_detail" name="tour_detail" rows="25"></textarea>
</div>
