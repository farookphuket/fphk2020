...
<form id="userProfile" action="<?php echo site_url("profile/userProfileSave");?>">
  ...
  <div class="form-group">
    ...
    <textarea name="u_about" id="u_about" class="form-control tinymce u_about" rows="10"></textarea>
    <p>&nbsp;</p>
  </div>
  <p>&nbsp;</p>
  <div class="form-group">
