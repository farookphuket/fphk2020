...
$(function(){
    ...
    var comment = (function(){
        ...
        //-------Wed 10 Oct 2018
        var $user_label = $el.find(".show_user_name");
        ...
        function getMyInfo(){
            $user_label.html("Anonymous user");
            var url = "<?php echo site_url("comment/getMyInfo");?>";
            $.ajax({
                url : url,
                success : function(e){
                    var rs = $.parseJSON(e);
                    $.each(rs.get_user,function(i,v){
                        ...
                        $user_label.html(v.name);
                        c_user_name.val(v.name);
                        c_user_email.val(v.email);
                        c_id.val(v.id);
        ...
        function showFormComment(cmd,id){
